...
var position_sticky_directive_1 = require("./position-sticky.directive");
var column_widths_directive_1 = require("./column-widths.directive");
var SharedModule = exports.SharedModule = function () {
    var _classDecorators = [(0, core_1.NgModule)({
            imports: [
                common_1.CommonModule
            ],
            declarations: [
                position_sticky_directive_1.PositionStickyDirective,
                column_widths_directive_1.ColumnWidthsDirective
            ],
            exports: [
                position_sticky_directive_1.PositionStickyDirective,
                column_widths_directive_1.ColumnWidthsDirective
    ...
    var SharedModule = _classThis = /** @class */ (function () {
        ...
        SharedModule_1.forRoot = function () {
            return {
